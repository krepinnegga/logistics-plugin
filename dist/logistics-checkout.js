...
class LogisticsCheckoutHandler {
  ...
  injectShippingOptions() {
    const shippingContainer = document.querySelector('.wp-block-woocommerce-checkout-order-summary-shipping-block .wc-block-components-totals-shipping');
    ...
    // Create container for our options
    const optionsContainer = document.createElement('div');
    optionsContainer.className = 'logistics-shipping-options';
            ...
            <div class="wc-block-components-radio-control__option-layout">
              <div class="wc-block-components-radio-control__label-group">
                ...
                <span class="wc-block-components-radio-control__secondary-label">
                  <span class="wc-block-components-formatted-money-amount">₵${service.fee}</span>
                </span>
              </div>
            </div>
          </label>
    ...
    // Insert before the free shipping notice
    shippingContainer.insertBefore(optionsContainer, shippingContainer.firstChild);
  }
  ...
  extractWeightFromDescription(productItem) {
    // Implement logic to extract weight from product metadata if available
